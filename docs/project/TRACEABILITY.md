...
| VS-01 / C-02 missing expense | F-012 new receipt creation | Complete ZenMoney create shape; duplicate-safe apply | `tests/direct-write.test.ts`, live E2E log | Complete |
